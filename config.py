...
def parse_args():
	...
	parser.add_argument('--classification_step', type=int, default=10, help='Number of rounds of mini batch SGD per epoch for classification')
	...
	parser.add_argument('--top_k', type=int, default=100, help='Top k for precision and recall')
